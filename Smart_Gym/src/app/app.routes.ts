...
export const routes: Routes = [
  ...
  },
  {
    path: 'home-admin',
    loadComponent: () =>
      import('./home-admin/home-admin.page').then((m) => m.HomeAdminPage),
    canActivate: [authGuard, adminGuard],
  },
  {
    path: 'home-reservas',
    loadComponent: () =>
      import('./home-reservas/home-reservas.page').then((m) => m.HomeReservasPage),
    canActivate: [authGuard],
  },
  {
    path: 'gestionar-clases',
    loadComponent: () =>
      import('./gestionar-clases/gestionar-clases.page').then((m) => m.GestionarClasesPage),
    canActivate: [authGuard, adminGuard],
  },
  {
    path: 'reservas',
  ...
  },
  {
    path: 'socios-form',
    loadComponent: () =>
      import('./pages/socios-form/socios-form.page').then((m) => m.SociosFormPage),
    canActivate: [authGuard, adminGuard],
  },
  {
    path: 'socios-form/:id',
